...
<div id="gridRubrikartikel">
	<div id="rubrik-picker" class="toolbar">
		<button id="bt-add" class="tombol_aksi" onclick="loadForm('formtambahrubrik','xx');">Tambah Rubrik Berita Foto</button>
...
<th class=gridhead width=300><b>NAMA RUBRIK BERITA FOTO</b></th>
...
function gridpaging(hal){
			$.ajax({
				...
				data:{"hal": hal, "batas": 10, "komponen":"galeri" },
				beforeSend:function(){	loadDialogBuka(); },
				success:function(data){
