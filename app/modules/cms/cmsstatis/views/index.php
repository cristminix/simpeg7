...
function loadForm(tujuan,idd){	
	...
	var rubrik = $("#rubrik").val();
			$.ajax({
				...
				data:{"idd": idd, "rubrik": rubrik, "komponen":"statis" },
...
var rubrik = $('#rubrik').val();
			$.ajax({
				...
				data:{"hal": hal, "batas": 10, "rubrik": rubrik, "komponen":"statis"},
				beforeSend:function(){	loadDialogBuka(); },
				success:function(data){
...
<div id="gridRubrikartikel">
	<div id="rubrik-picker" class="toolbar">
		<button id="bt-add" class="tombol_aksi" onclick="loadForm('formcontent/0','xx');">Tambah Halaman Statis</button>
...
<th class=gridhead><b>JUDUL HALAMAN STATIS</b></th>
