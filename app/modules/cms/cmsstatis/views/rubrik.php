...
<div id="gridRubrikartikel">
	<div id="rubrik-picker" class="toolbar">
		<button id="bt-add" class="tombol_aksi" onclick="loadForm('formtambahrubrik','xx');">Tambah Rubrik Halaman Statis</button>
...
<th class=gridhead width=300><b>NAMA RUBRIK HALAMAN STATIS</b></th>
...
function gridpaging(hal){
			$.ajax({
				...
				data:{"hal": hal, "batas": 10, "komponen":"statis" },
				beforeSend:function(){	loadDialogBuka(); },
				success:function(data){
