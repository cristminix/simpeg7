...
function gridpaging(hal){
			$.ajax({
				type:"POST",
				url:"<?=base_url();?>cmsartikel/getkomentar/",
				data:{"hal": hal, "batas": 2 },
				success:function(data){
...
//tombol aksi<--
				table = table+ "</td>";
				table = table+ "<td class=gridcell align=left>" +item.nama_komentator+"</td>";
				table = table+ "<td class=gridcell align=left>" +item.email_komentator+"</td>";
				table = table+ "<td class=gridcell align=left>" +item.isi_komentar+"</td>";
...
<div style="clear:both"></div>
	<div  class="ui-jqgrid ui-widget ui-widget-content ui-corner-all"  style="box-shadow: 3px 3px 5px rgb(0,0,0);">
		<div style="padding:3px 5px 3px 5px" class="ui-jqgrid-titlebar ui-widget-header ui-corner-top ui-helper-clearfix">
			<span style="float:left">Daftar Komentar</span>
...
<th class=gridhead width=180><b>NAMA PENULIS</b></th>
<th class=gridhead width=180><b>EMAIL PENULIS</b></th>
<th class=gridhead><b>ISI KOMENTAR</b></th>
