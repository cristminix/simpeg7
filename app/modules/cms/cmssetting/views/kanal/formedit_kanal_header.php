<div style="float:left;width:80%;">
    <form id="content-form" method="post" action="<?=site_url('cmssetting/kanal/edit_header_aksi');?>" enctype="multipart/form-data">
    <div style="statussave"></div>
    <table width="100%" cellspacing="0" cellpadding="0" class="table-form-flat">
        <tr>
          <th colspan="4" style="border:none">FORM EDIT SETTING KANAL</th>
        </tr>
        <tr bgcolor="#99CCCC">
        ...
        <tr>
          <td>Judul Header</td>
          <td colspan="3">
		  <input type="text" id="judul_header" name="judul_header" class="ipt_text" style="width:400px;" value="<?=$judul_header; ?>" onblur="if(this.value=='') this.value='Wajib diisi';" onfocus="if(this.value=='Wajib diisi') this.value='';">
		  </td>
        </tr>
        <tr>
          <td>Sub Judul</td>
          <td colspan="3">
		  <input type="text" id="sub_judul" name="sub_judul" class="ipt_text" style="width:400px;" value="<?=$sub_judul; ?>" onblur="if(this.value=='') this.value='Wajib diisi';" onfocus="if(this.value=='Wajib diisi') this.value='';">
		  </td>
        </tr>
        <tr>
          <td>Tinggi header</td>
       ...
       <tr >
			...
			<td colspan="3">
				...
				<input type="hidden" name='idh' id='idh' value='<?=$idh;?>'>
...
function validasi_pengikut(opsi){
	...
	function langsung(){
			var idparent = $("#idd").val();
			var nnm = $.trim($("#nama_kanal").val());
			var nnp = $.trim($("#kanal_path").val());
		$( "#nama_kanal_"+idparent+"" ).html(nnm);
		$( "#kanal_path_"+idparent+"" ).html(nnp);
	}
