<div style="float:left;width:80%;">
    <form id="content-form" method="post" action="<?=site_url('cmssetting/kategori/edit_kategori_aksi');?>" enctype="multipart/form-data">
    <div style="statussave"></div>
    <table width="100%" cellspacing="0" cellpadding="0" class="table-form-flat">
        <tr>
          <th colspan="4" style="border:none">FORM EDIT RUBRIK</th>
        </tr>
        <tr bgcolor="#99CCCC">
          <td>Kanal</td>
        ...
        <tr>
          ...
          <td colspan="3">
		  <input type="text" id="nama_kategori" name="nama_kategori" class="ipt_text" style="width:400px;" value="<?=$nama_kategori;?>" onblur="if(this.value=='') this.value='Wajib diisi';" onfocus="if(this.value=='Wajib diisi') this.value='';">
		  </td>
        </tr>
        <tr>
          <td>Keterangan</td>
