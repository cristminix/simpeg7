...
.cellTb.left {  color:#000000; background-color:#D3F3FE; border-left: 1px dotted #3399CC; border-right: 1px dotted #3399CC; border-top: 1px dotted #3399CC; padding-left: 3px; padding-right: 3px}
    ...
    <form id="content-form" method="post" action="<?=site_url('cmssetting/wrapper/tambah_wrapper_aksi');?>" enctype="multipart/form-data">
    <table width="100%" cellspacing="0" cellpadding="0" class="table-form-flat">
        <tr>
          <th colspan="4">Form Tambah Wrapper</th>
        </tr>
        <tr>
          <td width="20%">Nama Wrapper</td>
          <td colspan="3"><input type="text" name="nama_wrapper" id="nama_wrapper" class="ipt_text" style="width:400px;"/></td>
        </tr>
        <tr>
          <td>Keterangan</td>
          <td colspan="3"><input type="text" name="keterangan" id="keterangan" class="ipt_text" style="width:400px;" /></td>
        </tr>
        <tr bgcolor="#99CCCC">
