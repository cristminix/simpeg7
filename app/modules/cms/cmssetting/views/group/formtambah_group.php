<div style="float:left;width:80%;">
    <form id="content-form" method="post" action="<?=site_url('cmssetting/group/tambah_group_aksi');?>" enctype="multipart/form-data">
    <div style="statussave"></div>
    <table width="100%" cellspacing="0" cellpadding="0" class="table-form-flat">
        <tr>
          <th colspan="4" style="border:none">FORM TAMBAH GRUP PENGGUNA</th>
        </tr>
        <tr>
          <td width="20%">Nama Grup Pengguna</td>
          <td colspan="3">
		  <input type="text" id="nama_grup" name="nama_grup"  class="ipt_text" style="width:400px;" value="Wajib diisi" onblur="if(this.value=='') this.value='Wajib diisi';" onfocus="if(this.value=='Wajib diisi') this.value='';">
		  </td>
        </tr>
        <tr>
          <td>Theme</td>
          <td colspan="3">
		  <input type="text" id="nama_section" name="nama_section"  class="ipt_text" style="width:400px;" value="Wajib diisi" onblur="if(this.value=='') this.value='Wajib diisi';" onfocus="if(this.value=='Wajib diisi') this.value='';">
		  </td>
        </tr>
        <tr>
          <td>Back Office</td>
          <td colspan="3">
		  <input type="text" id="backoffice" name="backoffice"  class="ipt_text" style="width:400px;" value="Wajib diisi" onblur="if(this.value=='') this.value='Wajib diisi';" onfocus="if(this.value=='Wajib diisi') this.value='';">
		  </td>
        </tr>
        <tr>
          <td>Keterangan</td>
