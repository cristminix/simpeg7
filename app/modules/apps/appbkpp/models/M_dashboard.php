...
//////////////////////////////////////////////////////////////////////////////////
    function getDashlist($id_menu='521'){
    ...
    function hitung_pegawai($unor = "all", $status_pegawai = "all") {
        ...
        } elseif ($status_pegawai == "Khusus") {
            $iStatus_pegawai = "AND status_pegawai='Khusus'"; //tmt_pns='0000-00-00'";	
        } else {
    ...
    function hitung_pegawai_unor($unor = "all", $pns = "all", $gender = "all") {
        if ($unor == "all") {
            ...
            $iUnor = "WHERE id_unor IN ($unor)";
        }
        if ($pns == "all") {
            $iPns = "";
        } elseif ($pns == "cpns") {
            $iPns = "AND tmt_pns='0000-00-00'";
        } else {
            $iPns = "AND tmt_pns!='0000-00-00'";
        }
        if ($gender == "all") {
    ...
    function hitung_pegawai_golongan($golongan = "all", $gender = "all", $unor = "all") {
        if ($golongan == "all") {
            ...
            $iGolongan = "WHERE kode_golongan='$golongan'";
        }
        if ($gender == "all") {
            $iGender = "";
        } else {
    ...
    function hitung_pegawai_pendidikan($pendidikan = "all", $gender = "all", $unor = "all") {
        if ($pendidikan == "all") {
            ...
            $iPendidikan = "WHERE nama_jenjang='$pendidikan'";
        }
        if ($gender == "all") {
            $iGender = "";
        } else {
    ...
    function hitung_pegawai_jabatan($jabatan = "all", $gender = "all", $unor = "all") {
        if ($jabatan == "all") {
            ...
            $iJabatan = "WHERE jab_type='$jabatan'";
        }
        if ($gender == "all") {
            $iGender = "";
        } else {
    ...
    function hitung_pegawai_kawin($kawin = "all", $gender = "all", $unor = "all") {
        if ($kawin == "all") {
            ...
            $iKawin = "WHERE status_perkawinan='$kawin'";
        }
        if ($gender == "all") {
            $iGender = "";
        } else {
    ...
    function hitung_pegawai_perkawinan($perkawinan = "all", $gender = "all", $unor = "all") {
        if ($perkawinan == "all") {
            ...
            $iPerkawinan = "WHERE status_perkawinan='$perkawinan'";
        }
        if ($gender == "all") {
            $iGender = "";
        } else {
