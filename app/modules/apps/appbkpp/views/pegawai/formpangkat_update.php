<tr id="row_tt" class="success prinsip">
	...
	<td colspan="2">
		<div style="clear:both;">
			<div style="float:left; width:130px;">Peringkat</div>
			<div style="float:left; width:10px;">:</div>
			<div style="float:left;"><input type="text" class="form-control row-fluid" id="nama_golongan" name="nama_golongan" value="<?=(!isset($val->nama_golongan)) ? '' : $val->nama_golongan;?>" style="height:30px;padding:1px 0px 0px 5px;"></div>
		</div>
		<div style="clear:both;">
		<div style="float:left; width:130px;">MK Peringkat</div>
			<div style="float:left; width:10px;">:</div>
			<div style="float:left;"><input type="text" class="form-control row-fluid" id="mk_peringkat" name="mk_peringkat" value="<?=(!isset($val->mk_peringkat)) ? '' : $val->mk_peringkat;?>" style="height:30px;padding:1px 0px 0px 5px;"></div>
		</div>
	</td>
	<td id="ipt_jabatan">
		...
		<div style="clear:both;">
			...
			<div style="float:left; width:10px;">:</div>
			<span><div style="float:left;"><input type="text" class="form-control row-fluid" id="sk_nomor" name="sk_nomor" value="<?=(!isset($val->sk_nomor)) ? '' : $val->sk_nomor;?>" style="height:30px;padding:1px 0px 0px 5px;"></div></span>
		</div>
		<div style="clear:both;">
