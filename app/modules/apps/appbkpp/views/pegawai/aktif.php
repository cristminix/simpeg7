						...
						<div class="col-lg-6">
							<div class="dropdown">
								...
								<ul class="dropdown-menu" role="menu" aria-labelledby="ddMenuT">
									...
									<li><a href="<?=site_url('admin/module/appbkpp/pegawai/pensiun');?>"   style="cursor:pointer;"><i class="fa fa-trophy fa-fw"></i> Pegawai Pensiun</a></li>
									<li><a href="#" onClick="setForm('sub','keluar');return false;"><i class="fa fa-external-link fa-fw"></i> Pegawai Mutasi Keluar</a></li>
									<li><a href="#" onClick="setForm('sub','pensiun');return false;" style="cursor:pointer;"><i class="fa fa-trophy fa-fw"></i> Pegawai Pensiun OLD</a></li>
						...
						<table class="table table-striped table-bordered table-hover">
							<thead>
								<tr>
									...
									<th style="width:150px;text-align:center; vertical-align:middle">FOTO</th>
	...
	<div class="col-lg-12">
     ...
     <div class="panel-body" style="padding:0px;">
		...
		<ul class="nav nav-tabs" role="tablist" id="myTab">
			...
			<li class="dropdown">
				...
				<ul id="ulmyTabDrop2" class="dropdown-menu" role="menu" aria-labelledby="myTabDrop1">
					...
					<li><a href="#dropdownDokumenElektronik" tabindex="-1" role="tab" data-toggle="tab"
					onclick="viewTabPegawai('dokumen_elektronik','dropdownDokumenElektronik');return false;">
						<i class="fa fa-file fa-fw"></i> Dokumen Elektronik</a></li>	
				</ul>
		...
		<div class="tab-content" style="padding:5px;">
		  ...
		  <div class="tab-pane fade" id="dropdownDokumenElektronik">Dokumen Elektronik</div>
		</div>
	</div>
	<!-- /.panel-body -->
	</div>
...
var jenjang = $('#a_jenjang').val();
	...
	//tombol aksi-->
					...
					table = table+ "</td>";
	//tombol aksi<--
					table = table+ "<td style='padding:3px;'><img src="+item.photo_url+" class='img-responsive' style='margin:0 auto;display:block'/></td>";
