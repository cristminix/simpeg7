<tr id="row_tt" class="success prinsip">
	...
	<td id="ipt_jabatan">
		...
		<div style="clear:both;">
			...
			<select class="form-control" id="jenis_diklat" name="jenis_diklat" style="height:30px;padding:1px 0px 0px 5px;" <?=(!isset($val->jenis_diklat));?> >
...
<?php	}	?>
			<div class="btn btn-primary" onclick="hapus();"><i class="fa fa-trash fa-fw"></i> Hapus</div>
