<tr id="row_tt" class="success prinsip">
	...
	<td id="ipt_psikotes">
		<div style="clear:both;">
			<div style="float:left;"><input type="text" class="form-control" id="tanggal_tes" name="tanggal_tes" value="<?=(!isset($val->tanggal_tes))?'':$val->tanggal_tes;?>" placeholder="dd-mm-yyyy" style="height:30px;padding:1px 0px 0px 5px;"></div>
		</div>
		
		</td>
		<td>
		<div style="clear:both;">
			<span><div style="display:table;"><input type="text" class="form-control row-fluid" id="tempat" name="tempat" value="<?=(!isset($val->tempat))?'':$val->tempat;?>" style="height:30px;padding:1px 0px 0px 5px;"></div></span>
		</div>
