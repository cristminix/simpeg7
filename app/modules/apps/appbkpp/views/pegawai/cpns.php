								...
								<div class="col-lg-6">
									<div class="dropdown"><button class="btn btn-primary dropdown-toggle btn-xs" type="button" id="ddMenuT" data-toggle="dropdown"><span class="fa fa-binoculars fa-fw"></span></button>
										<ul class="dropdown-menu" role="menu" aria-labelledby="ddMenuT">
											<li role="presentation"><a href="<?=site_url('admin/module/appbkpp/pegawai/aktif');?>" role="menuitem" tabindex="-1" style="cursor:pointer;"><i class="fa fa-arrows fa-fw"></i> Daftar Pegawai Aktif</a></li>
											<li role="presentation" class="divider">
											<li role="presentation"><a role="menuitem" tabindex="-1" style="cursor:pointer;"><i class="fa fa-sort-amount-desc fa-fw"></i> Daftar Urut Kepangkatan</a></li>
											<li role="presentation" class="divider">
											<li role="presentation"><a href="<?=site_url('admin/module/appbkpp/pegawai/pns');?>" role="menuitem" tabindex="-1" style="cursor:pointer;"><i class="fa fa-star fa-fw"></i> Daftar PNS</a></li>
											<li role="presentation"><a role="menuitem" tabindex="-1" style="cursor:pointer;"><i class="fa fa-star-half-o fa-fw"></i> Daftar CPNS</a></li>
											<li role="presentation" class="divider">
...
var batas = $('#item_length').val();
	$.ajax({
		...
		data:{"hal": hal, "batas": batas,"cari":cari,"pns":"cpns"},
		beforeSend:function(){	
