	...
	<div class="col-lg-12">
		<div class="panel panel-success">
			<div class="panel-heading">
				<i class="fa fa-star-half-o fa-fw"></i> Data Pengangkatan Kontrak Pegawai
			</div>
              ...
              <div class="form-group">
                ...
                <div class="dateContainer">
                  <div class="input-group date datetimePicker" id="tmt_kontrak">
                    ...
                    <?=form_input('tmt_kontrak',$data->tmt_kontrak,'class="form-control" id="tmt_kontrak" placeholder="DD-MM-YYYY"  data-date-format="DD-MM-YYYY" disabled=""');?>
                  </div>
