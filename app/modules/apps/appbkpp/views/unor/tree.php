						...
						<div class="row">
								<div class="col-lg-6">
									<div class="dropdown"><button class="btn btn-primary dropdown-toggle btn-xs" type="button" id="ddMenuT" data-toggle="dropdown"><span class="fa fa-sitemap fa-fw"></span></button>
										...
										Susunan Hirarki Struktur Organisasi & Struktur Jabatan
									</div>
								</div>
								<div class="col-lg-6">
...
<th style="width:450px;vertical-align:middle;">KODE<br /><b>NAMA STRUKTUR ORGANISASI</b><br />KUNCI PENCARIAN</th>
