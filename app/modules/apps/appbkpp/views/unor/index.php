								...
								<div class="col-lg-6">
									<div class="dropdown"><button class="btn btn-primary dropdown-toggle btn-xs" type="button" id="ddMenuT" data-toggle="dropdown"><span class="fa fa-list fa-fw"></span></button>
										<ul class="dropdown-menu" role="menu" aria-labelledby="ddMenuT">
											<li role="presentation"><a role="menuitem" tabindex="-1" style="cursor:pointer;"><i class="fa fa-list fa-fw"></i> Daftar Struktur Organisasi & Struktur Jabatan per due-Date</a></li>
											...
											<li role="presentation"><a href="<?=site_url('admin/module/appbkpp/unor/master');?>" role="menuitem" tabindex="-1" style="cursor:pointer;"><div class="btn btn-primary btn-xs"><i class="fa fa-tasks fa-fw"></i></div> Daftar Struktur Organisasi & Struktur Jabatan Master</a></li>
										</ul>
										Daftar Struktur Organisasi & Struktur Jabatan per due-Date
									</div>
								</div>
								<div class="col-lg-6">
		...
		success:function(data){
			if((data.hslquery.length)>0){
				...
				$.each( data.hslquery, function(index, item){
					...
					table = table+ "<td style='padding:3px;'><div id='kol_2_"+item.id_unor+"'><b>"+item.nomenklatur_jabatan+"</b><br /><u>pada</u><br />"+item.nomenklatur_pada+"</div></td>";
