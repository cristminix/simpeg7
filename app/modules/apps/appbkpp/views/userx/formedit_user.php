<div style="float:left;width:80%;">
    ...
    <table width="100%" cellspacing="0" cellpadding="0" class="table-form-flat">
        ...
        <tr>
          ...
          <td colspan="3">
		  <input type="text" id="nm_pengguna" name="nm_pengguna" class=ipt_text style="width:250px;" value="<?=$hslquery[0]->nama_user;?>" onblur="if(this.value=='') this.value='Wajib diisi';" onfocus="if(this.value=='Wajib diisi') this.value='';">
		  </td>
        </tr>
        <tr>
          <td>Username</td>
