								...
								<div class="col-lg-6">
									<div class="dropdown"><button class="btn btn-primary dropdown-toggle btn-xs" type="button" id="ddMenuT" data-toggle="dropdown"><span class="fa fa-list fa-fw"></span></button>
										<ul class="dropdown-menu" role="menu" aria-labelledby="ddMenuT">
											<li role="presentation"><a onClick="pilTipe('all'); return false;" role="menuitem" tabindex="-1" style="cursor:pointer;"><i class="fa fa-user fa-fw"></i> Seluruh Grup Pengguna</a></li>
											<li role="presentation"><a onClick="pilTipe('superadmin'); return false;" role="menuitem" tabindex="-1" style="cursor:pointer;"><i class="fa fa-user fa-fw"></i> Super Admin</a></li>
											<li role="presentation"><a onClick="pilTipe('admin'); return false;" role="menuitem" tabindex="-1" style="cursor:pointer;"><i class="fa fa-user fa-fw"></i> Admin</a></li>
											<li role="presentation"><a onClick="pilTipe('pegawai'); return false;" role="menuitem" tabindex="-1" style="cursor:pointer;"><i class="fa fa-user fa-fw"></i> Pegawai</a></li>
										
										</ul>
										<span id="judul">Group Pengguna</span>
									</div>
								</div>
								<div class="col-lg-6">
									<div class="btn btn-primary btn-xs" style="float:right;" onClick="setForm('tambah','xx');"><i class="fa fa-plus fa-fw"></i> Tambah Pengguna</div>
								</div>
						</div>
		</div>
...
<th style="width:105px;text-align:center; vertical-align:middle">USER NAME</th>
<th style="text-align:center; vertical-align:middle">NAMA PENGGUNA</th>
<th style="text-align:center; vertical-align:middle">GRUP PENGGUNA</th>
...
var tipe = $('#tipe').html();
	$.ajax({
		type:"POST",
		url:"<?=site_url();?>appbkpp/user/getdata",
	...
	//tombol aksi-->
					table = table+ "<td valign=top style='padding:3px 0px 0px 0px;' align=center>";
						...
						table = table+ '<li role="presentation"><a role="menuitem" tabindex="-1" style="cursor:pointer;" onClick="setForm(\'edit\',\''+item.user_id +'\');"><i class="fa fa-edit fa-fw"></i> Edit data</a></li>';
						table = table+ '<li role="presentation" class="divider"></li>';
						table = table+ '<li role="presentation"><a role="menuitem" tabindex="-1" style="cursor:pointer;" onClick="setForm(\'hapus\',\''+item.user_id +'\');"><i class="fa fa-trash fa-fw"></i> Hapus data</a></li>';
						table = table+ "</ul></div>";
					table = table+ "</td>";
	//tombol aksi<--
					table = table+ "<td style='padding:3px;'>"+item.username+"</td>";
					table = table+ "<td style='padding:3px;'>"+item.nama_user+"</td>";
					table = table+ "<td style='padding:3px;'>"+item.group+"</td>";
					table = table+ "<td style='padding:3px;'>"+item.status+"</td>";
					table = table+ "</tr>";
					no++;
				}); //endeach
					$('#list').html(table);
...
var hal=$("#inputpaging").val();
	$.ajax({
		type:"POST",
		url:"<?=site_url();?>appbkpp/user/form"+aksi,
