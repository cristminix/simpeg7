...
function loadForm(tujuan,idd,level,idparent){	
	...
	$("#gridPost").hide();
			$.ajax({
				type:"POST",
				url:"<?=site_url();?>appbkpp/menu/"+tujuan+"/",
...
<!--Grid::awal--->
		<div id="isiGrid">
<table width="100%" cellspacing=0 style="background-color:#FFFFFF; border-bottom: 1px dotted #3399CC; ">
<thead id=gridhead>
<tr height=35>
...
var mulai=0;
			$.ajax({
				type:"POST",
				url:"<?=site_url();?>appbkpp/menu/getmenu/",
