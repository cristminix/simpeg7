...
class Cetak extends MX_Controller
{
    ...
    public function index($awal)
    {
        ...
        $this->myexcel->getActiveSheet()->setCellValue('J' . $rc, 'ORGANISASI');
        ...
        $this->myexcel->getActiveSheet()->setCellValue('T' . $rc, '');
        ...
        $hsl = $this->m_pegawai->get_pegawai($cari, $start, $batas, $pns, $unor, $kode, $pkt, $jbt, $ese, $tugas, $gender, $agama, $status, $jenjang);
        ...
        foreach ($hsl as $key => $val) {
            ...
            $pangkat = $val->nama_pangkat . " - " . $val->nama_golongan;
