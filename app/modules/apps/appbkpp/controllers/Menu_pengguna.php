...
class Menu_pengguna extends MX_Controller
{
    ...
    public function getmenupengguna()
    {
    ...
    public function formtambah_menu_pengguna()
    {
    ...
    public function getmenuuserAll()
    {
        $gg = $this->getpanggilmenu(2, 0, 1, "", "", $_POST['id_setting'], $_POST['id_setting_ref'], $_POST['group_id']);
        echo $gg;
    }

    public function getpanggilmenu($sett, $idp, $level=1, $ni="", $di="", $set, $set_ref, $grup)
    {
    ...
    public function formhapus_menu_pengguna()
    {
        ...
        if ($_POST['level']==1) {
            ...
            if (count($isi)==1) {
                ...
                for ($i=0;$i<count($idp)-2;$i++) {
                    $data['rowparent'].=$idp[$i]."_";
                    $data['parent'].=($i==0)?$idp[$i]:"_".$idp[$i];
                }
            } else {
    ...
    public function hapus_menu_pengguna_aksi()
    {
