...
class Menu extends MX_Controller
{
    ...
    public function formtambah_menu()
    {
    ...
    public function edit_menu_aksi()
    {
        $idd=$_POST['idd'];
        $ang=explode("*", $_POST['nama_menu']);
        $ipp['menu_name']=$ang[0];
    ...
    public function formhapus_menu()
    {
    ...
    public function hapus_menu_aksi($id_setting=2)
    {
        $idd=$_POST['idd'];
