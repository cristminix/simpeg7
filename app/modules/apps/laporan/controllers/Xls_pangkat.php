...
class Xls_pangkat extends MX_Controller {
...
//name the worksheet
$this->myexcel->getActiveSheet()->setTitle('Laporan Pangkat');
//set cell A1 content with some text
$this->myexcel->getActiveSheet()->setCellValue('B1', 'Laporan Kepangkatan Pegawai');
...
$this->myexcel->getActiveSheet()->getColumnDimension("H")->setWidth(30);
...
$this->myexcel->getActiveSheet()->setCellValue('G'.$rc, 'PANGKAT');
$this->myexcel->getActiveSheet()->getStyle('G'.$rc)->applyFromArray($styleArray3);
$this->myexcel->getActiveSheet()->setCellValue('H'.$rc, 'GOLONGAN');
...
$styleArray7 = array(
      'borders' => array(
        ...
        'bottom' => array('style' => PHPExcel_Style_Border::BORDER_HAIR,), 
			...
			$batas = $iptHal1;
			$start = ($awal-1)*$batas;
			// $hsl = $this->m_lap->get_kepangkatan(NULL,$iptHal1,$iptHal2);
			$hsl = $this->m_lap->get_lap_kepangkatan($iptHal1,$iptHal2,$tgl1,$tgl2);
$rc=5;$i=$start+1;
...
///////////////////////////////////////////////////////////////////////////
$filename='daftar_pangkat_pegawai.xls'; //save our workbook as this file name
