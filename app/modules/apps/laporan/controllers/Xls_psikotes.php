...
class Xls_psikotes extends MX_Controller {
...
//name the worksheet
$this->myexcel->getActiveSheet()->setTitle('Laporan Psikotes');
//set cell A1 content with some text
$this->myexcel->getActiveSheet()->setCellValue('B1', 'Laporan Psikotes Pegawai');
...
$this->myexcel->getActiveSheet()->getColumnDimension("G")->setWidth(80);
...
$styleArray7 = array(
      'borders' => array(
        ...
        'bottom' => array('style' => PHPExcel_Style_Border::BORDER_HAIR,), 
			...
			$batas = $iptHal1;
			$start = ($awal-1)*$batas;
			$hsl = $this->m_lap->get_lap_psikotes($iptHal1,$iptHal2,$tgl1,$tgl2);
...
///////////////////////////////////////////////////////////////////////////
$filename='daftar_psikotes_pegawai.xls'; //save our workbook as this file name
