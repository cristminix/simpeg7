...
class Xls_sanksi extends MX_Controller {
...
//name the worksheet
$this->myexcel->getActiveSheet()->setTitle('Laporan Sanksi');
//set cell A1 content with some text
$this->myexcel->getActiveSheet()->setCellValue('B1', 'Laporan Sanksi Pegawai');
...
$this->myexcel->getActiveSheet()->getColumnDimension("G")->setWidth(200);
...
$styleArray7 = array(
      'borders' => array(
        ...
        'bottom' => array('style' => PHPExcel_Style_Border::BORDER_HAIR,), 
			...
			$batas = $iptHal1;
			$start = ($awal-1)*$batas;
			$hsl = $this->m_lap->get_lap_sanksi($iptHal1,$iptHal2,$tgl1,$tgl2);
$rc=5;$i=$start+1;
...
///////////////////////////////////////////////////////////////////////////
$filename='daftar_sanksi_pegawai.xls'; //save our workbook as this file name
