...
class Pendidikan_ro extends MX_Controller {
    ...
    $content['id_pegawai'] = $id_pegawai;
		...
		$content['panel_body'] = $this->load->view('pendidikan/panel_body_ro',$content,true);

		$this->load->view('pendidikan/default_ro',$content);
	}
