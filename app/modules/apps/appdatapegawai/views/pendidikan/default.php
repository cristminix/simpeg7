		...
		<div class="panel panel-info">
			<div class="panel-heading row-fluid">
				...
				<button data-toggle="dropdown" 
					class="btn btn-primary btn-xs" type="button" title="Tambah Data Pendidikan"
					onclick="loadForm('<?php echo $id_pegawai;?>','add','pendidikan','form','form_pendidikan');return false">
