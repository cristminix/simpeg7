  <div class="row">
	<div class="col-lg-6">
<form id="content-form" method="post" action="<?=site_url("apppenggajian/potongan_jenis/edit_aksi");?>" enctype="multipart/form-data" role="form">
		<div class="panel panel-primary">
			<div class="panel-heading"><i class="fa fa-edit fa-fw"></i> <b>Form Edit Data Master Potongan Jenis</b></div>
				  ...
				  <div class="row">
					<div class="col-lg-12">
							<div class="form-group">
								...
								<input  type="text" style="text-align: left"  id="potongan_jenis" name="potongan_jenis" size="70" value="<?=@$unit->potongan_jenis;?>" class="form-control" >
							</div>
							<div class="form-group">
								<label>Keterangan</label>
								<textarea  style="text-align: left" type="text" id="keterangan" name="keterangan" size="70" align="right"  class="form-control"><?=@$unit->keterangan;?></textarea>
							</div>
							<label>Status</label>
							<div class="form-group">
								<?php
