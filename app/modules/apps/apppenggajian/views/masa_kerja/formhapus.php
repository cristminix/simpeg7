  <div class="row">
	<div class="col-lg-6">
<form id="content-form" method="post" action="<?=site_url("apppenggajian/masa_kerja/hapus_aksi");?>" enctype="multipart/form-data" role="form">
		<div class="panel panel-primary">
			<div class="panel-heading"><i class="fa fa-edit fa-fw"></i> <b>Form Hapus Data Master Masa Kerja</b></div>
			<div class="panel-body">
							<div class="form-group">
								<label>Masa Kerja</label>
								<input type="text" style="text-align: left"  id="masa_kerja" name="masa_kerja" size="70" value="<?=@$unit->masa_kerja;?>" class="form-control" onkeyup="numberFormat(this, '')" onchange="numberFormat(this, '') " disabled="">
							</div>
