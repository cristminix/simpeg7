  <div class="row">
	<div class="col-lg-6">
<form id="content-form" method="post" action="<?=site_url("apppenggajian/masa_kerja/tambah_aksi");?>" enctype="multipart/form-data" role="form">
		<div class="panel panel-primary">
			<div class="panel-heading"><i class="fa fa-edit fa-fw"></i> <b>Form Tambah Data Master Masa Kerja</b></div>
				  ...
				  <div class="row">
					<div class="col-lg-12">
							...
							<div class="form-group">
								...
								<input  style="text-align: left" type="text" id="masa_kerja" name="masa_kerja" size="70" align="right" value="" onkeyup="numberFormat(this, '')" class="form-control">
							</div>
