  <div class="row">
	<div class="col-lg-6">
<form id="content-form" method="post" action="<?=site_url("apppenggajian/tunjangan_jenis/edit_aksi");?>" enctype="multipart/form-data" role="form">
		<div class="panel panel-primary">
			<div class="panel-heading"><i class="fa fa-edit fa-fw"></i> <b>Form Edit Data Master Tunjangan Jenis</b></div>
				  ...
				  <div class="row">
					<div class="col-lg-12">
							<div class="form-group">
									...
									<?=form_dropdown('id_tunjangan_kelompok',$this->dropdowns->getTunjKelompok(),(!isset($unit->id_tunjangan_kelompok))?'':$unit->id_tunjangan_kelompok,'class="form-control" style="padding-left:2px; padding-right:2px; float:left;" id="id_tunjangan_kelompok" ');?>	
							...
							<div class="form-group">
								...
								<input type="text"  id="tunjangan_jenis" name="tunjangan_jenis" size="70" value="<?=@$unit->tunjangan_jenis;?>" class="form-control">
							</div>
