  <div class="row">
	<div class="col-lg-6">
<form id="content-form" method="post" action="<?=site_url("apppenggajian/pendapatan_lain/tambah_aksi");?>" enctype="multipart/form-data" role="form">
		<div class="panel panel-primary">
			<div class="panel-heading"><i class="fa fa-edit fa-fw"></i> <b>Form Tambah Data Master Pendapatan Lain</b></div>
				  ...
				  <div class="row">
					<div class="col-lg-12">
							...
							<div class="form-group">
								...
								<input  style="text-align: left" type="text" id="pendapatan_lain" name="pendapatan_lain" size="70" align="right" value=""  class="form-control">
							</div>
