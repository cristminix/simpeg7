  <div class="row">
	<div class="col-lg-6">
<form id="content-form" method="post" action="<?=site_url("apppenggajian/pendapatan_lain/edit_aksi");?>" enctype="multipart/form-data" role="form">
		<div class="panel panel-primary">
			<div class="panel-heading"><i class="fa fa-edit fa-fw"></i> <b>Form Edit Data Master Pendapatan Lain</b></div>
				  ...
				  <div class="row">
					<div class="col-lg-12">
							<div class="form-group">
								...
								<input  type="text" style="text-align: left"  id="pendapatan_lain" name="pendapatan_lain" size="70" value="<?=@$unit->pendapatan_lain;?>" class="form-control" >
							</div>
