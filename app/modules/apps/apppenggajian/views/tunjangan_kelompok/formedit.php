  <div class="row">
	<div class="col-lg-6">
<form id="content-form" method="post" action="<?=site_url("apppenggajian/tunjangan_kelompok/edit_aksi");?>" enctype="multipart/form-data" role="form">
				  ...
				  <div class="row">
					<div class="col-lg-12">
							<div class="form-group">
								...
								<input  type="text" style="text-align: left"  id="tunjangan_kelompok" name="tunjangan_kelompok" size="70" value="<?=@$unit->tunjangan_kelompok;?>" class="form-control"  >
							</div>
