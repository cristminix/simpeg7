  <div class="row">
	<div class="col-lg-6">
<form id="content-form" method="post" action="<?=site_url("apppenggajian/tunjangan_kelompok/hapus_aksi");?>" enctype="multipart/form-data" role="form">
		<div class="panel panel-primary">
			<div class="panel-heading"><i class="fa fa-edit fa-fw"></i> <b>Form Hapus Data Master Masa Kerja</b></div>
			<div class="panel-body">
							<div class="form-group">
								<label>Masa Kerja</label>
								<input type="text" style="text-align: left"  id="tunjangan_kelompok" name="tunjangan_kelompok" size="70" value="<?=@$unit->tunjangan_kelompok;?>" class="form-control" disabled="">
							</div>
                        ...
                        ?>
							...
							<input type="hidden" id="idd" name="idd" value="<?=@$unit->id_tunjangan_kelompok;?>">
