...
<div class="row">
	<div class="col-lg-12">
	<h4>Target sasaran kinerja pegawai belum diisi, tidak dapat diajukan kepada pejabat penilai...</h4>
	</div>
	<!-- /.col-lg-6 -->
</div>
...
if($skp->aju_penilai!=NULL and $skp->status=="aju_penilai")
{
?>
<div class="row">
	<div class="col-lg-12">
	<h4>SKP sudah diajukan kepada pejabat penilai...</h4>
	</div>
	<!-- /.col-lg-6 -->
</div>
<script type="text/javascript">
