...
<div class="row">
	...
	<div class="dropdown"><button class="btn btn-primary dropdown-toggle btn-xs" type="button" id="ddMenu1" data-toggle="dropdown"><span class="fa fa-tasks fa-fw"></span></button>
		<ul class="dropdown-menu" role="menu" aria-labelledby="ddMenu1">
			...
			<li role="presentation"><a role="menuitem" tabindex="-1" style="cursor:pointer;" onClick="bsmShow('realisasi_kelola/form_acc_skp','1','1','1');"><i class="fa fa-upload fa-fw"></i>Disetujui, Ajukan kepada Verifikatur</a></li>
		</ul>
	</div>
	</div>
...
function kembali(){
			$.ajax({
			type:"POST",
			url:"<?=site_url();?>appskp/sett/pantau_realisasi",
