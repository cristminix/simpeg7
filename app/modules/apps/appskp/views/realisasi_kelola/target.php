...
function setForm(tujuan,idd,no,urutan){
	...
	btt['form_acc_skp'] = "<button id='btAct' type=sumbit class='btn btn-primary' onclick='ajukan(); return false;'><i class='fa fa-upload fa-fw'></i> Setuju dan Ajukan</button>"; 
			$.ajax({
			type:"POST",
...
<div class="row">
	<div class="col-lg-12" style="text-align:right; padding-bottom:10px;">
		 <a href="<?=site_url('admin/module/appskp/realisasi_kelola');?>"><button class="btn btn-primary" type="button"><i class="fa fa-fast-backward fa-fw"></i>Kembali...</button></a>
	</div>
	<!-- /.col-lg-12 -->
</div>
<!-- /.row -->
<div class="row">
	...
	<div class="dropdown"><button class="btn btn-primary dropdown-toggle btn-xs" type="button" id="ddMenu1" data-toggle="dropdown"><span class="fa fa-tasks fa-fw"></span></button>
		<ul class="dropdown-menu" role="menu" aria-labelledby="ddMenu1">
			...
			<li role="presentation"><a role="menuitem" tabindex="-1" style="cursor:pointer;" onClick="setForm('form_acc_skp','1','1','1');"><i class="fa fa-upload fa-fw"></i>Disetujui, Ajukan kepada Verifikatur</a></li>
		</ul>
	</div>
	</div>
