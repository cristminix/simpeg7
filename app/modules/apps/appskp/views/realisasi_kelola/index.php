...
<th style="width:350px;">TAHUN / PERIODE / TAHAPAN</th>
...
<td id='aksi_<?=$val->id_skp;?>' align=center>
	<a href="<?=site_url('appskp/realisasi_kelola/alih/'.$val->id_skp);?>" style="cursor:pointer;"><button class="btn btn-primary dropdown-toggle btn-xs" type="button" id="dropdownMenu1"><i class="fa fa-binoculars fa-fw"></i></button></a>
</td>
...
?>
<tr>
<td colspan=7 align="center">Tidak Ada Pengajuan Realisasi Kinerja</td>
</tr>
<?php
}
?>
