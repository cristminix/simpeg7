...
?></td>
            ...
            <tr>
                <td><?php echo lang('TPP Amount'); ?></td>
                <td><?php echo lang('#CURRENCY_SYMBOL') . " " . number_format($detail->alw_tpp, 2, ",", "."); ?></td>
            </tr>
            <tr>
                <td><?php echo lang('TPP Remark'); ?></td>
                <td><?php echo $detail->alw_tpp_remark; ?></td>
            </tr>
        </tbody>
        <tfoot>
            <tr>
