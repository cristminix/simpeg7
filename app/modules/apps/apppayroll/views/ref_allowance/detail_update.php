            ...
            foreach ($ls as $i => $r):
                ...
                <tr>
                    ...
                    foreach ($field_list as $idx => $field):
                        ...
                        printf('<td class="%s" align="%s">%s</td>', $css_class, $cell_alignment, $text);
                    endforeach;
                    $text = isset($update_action_status[$r->id]) ? $update_action_status[$r->id] : '0';
                    $text .= ' ';
                    $text .= lang('Rows updated');
                    printf('<td class="%s" align="%s">%s</td>', $css_class, $cell_alignment, $text);
                    ?>
        ...
        <tfoot>
            <tr>
                <td colspan="<?php 
                        ...
                        echo $colspan;?>"><a class="btn" href="<?php echo $back_url; ?>"><span class="fa fa-arrow-left"></span> <?php echo lang('back'); ?></a></td>
            </tr>
        </tfoot>
    </table>
</div>
<?php
debug($update_action_status);
?>
