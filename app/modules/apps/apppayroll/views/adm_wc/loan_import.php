                    ...
                    <tbody>
                        ...
                        foreach ($rs_confirm_list as $i => $row):
                            ?><tr>
                                ...
                                <td align="right"><?php
                                    $text = lang('#CURRENCY_SYMBOL') . " " . number_format($row['loan'], 2, ",", ".");
                                    echo $text;
                                    ?>
                                    <input type="hidden" name="<?php echo md5('ddc_wcl'); ?>[]" value="<?php echo $row['loan']; ?>"></td>
                                    <?php
                                    ?></tr><?php
                                $n++;
                            endforeach;
...
<div class="users form">
    ...
    <form class="form-horizontal" role="form" id="UserAddForm" method="post" accept-charset="utf-8" enctype="multipart/form-data">
        ...
        <fieldset>
            <?php
            $field_alias = md5('file_import_loan');
            $input       = array(
