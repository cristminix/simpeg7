...
<div>
    <table class="table table-bordered table-condensed table-striped">
        ...
        <tbody>
            ...
            <tr>
                <td width="200"><?php echo lang('ACC ID'); ?></td>
                <td><?php echo $detail->acc_id; ?></td>
            </tr>
            <tr>
                <td width="200"><?php echo lang('Active period'); ?></td>
                <td><?php
                    echo date('d/m/Y', strtotime($detail->acc_reg_date));
                    echo ' - ';
                    if ($detail->acc_term):
                        echo date('d/m/Y', strtotime($detail->acc_term));
                    else:
                        echo lang('to date');
                    endif;
                    ?></td>
