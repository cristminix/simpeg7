...
?></td>
            ...
            <tr>
                <td><?php echo lang('TPTGR Amount'); ?></td>
                <td><?php echo lang('#CURRENCY_SYMBOL') . " " . number_format($detail->ddc_tpt, 2, ",", "."); ?></td>
            </tr>
            <tr>
                <td><?php echo lang('TPTGR Remark'); ?></td>
                <td><?php echo $detail->ddc_tpt_remark; ?></td>
            </tr>
        </tbody>
        <tfoot>
            <tr>
