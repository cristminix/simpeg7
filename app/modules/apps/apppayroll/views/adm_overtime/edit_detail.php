...
<div>
    <table class="table table-bordered table-condensed table-striped">
        ...
        <tbody>
            ...
            <tr>
                <td width="200"><?php echo lang('Job Unit'); ?> - <?php echo lang('Job Title'); ?></td>
                <td><?php echo $detail->job_unit; ?> - <?php echo $detail->job_title; ?></td>
            </tr>
...
<div class="users form">
    <form class="form-horizontal" role="form" id="UserAddForm" method="post" accept-charset="utf-8">
        ...
        <fieldset>
            <?php
            //alw_ot
            $field_alias      = md5('alw_ot');
            $input            = array(
                'field_alias' => $field_alias,
                'label'       => lang('Overtime Allowance'),
//                'type'        => 'number',
                'col_lg'      => '3',
                'col_sm'      => '3',
            );
