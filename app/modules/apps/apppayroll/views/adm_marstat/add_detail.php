...
<div>
    <table class="table table-bordered table-condensed table-striped">
        ...
        <tbody>
            ...
            <tr>
                <td width="200"><?php echo lang('Spouse Name'); ?></td>
...
<div class="users form">
    <form class="form-horizontal" role="form" id="UserAddForm" method="post" accept-charset="utf-8">
        ...
        <fieldset>
            ...
            //mar_stat
            $mar_stat_ls = array(
                'Menikah'  => lang('Married'),
                'Bercerai' => lang('Divorced')
            );

            $field_alias = md5('mar_stat');

            $input            = array(
                'field_alias'  => $field_alias,
                'label'        => lang('Marriage Status'),
                'type'         => 'select',
                'empty'        => true,
                'list_options' => $mar_stat_ls,
                'col_lg'       => '2',
                'col_sm'       => '2',
            );
            if (isset($rs_form_input[$field_alias]['err_msg']))
...
//eff_date
            ...
            $field_alias = md5('alw_rc_sp_cnt');
            $input            = array(
                'field_alias'  => $field_alias,
                'label'        => lang('Rice Alw. Stat.'),
                'type'         => 'select',
                'empty'        => true,
                'list_options' => $alw_rc_get_ls,
                'col_lg'       => '2',
                'col_sm'       => '2',
            );
            if (isset($rs_form_input[$field_alias]['err_msg']))
