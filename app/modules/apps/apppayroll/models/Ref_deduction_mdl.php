...
class Ref_Deduction_Mdl extends Apppayroll_Frontmdl {

    public $tbl                  = 'apr_deduction';
    ...
    public $rs_use_form_filter   = 'apr_deduction';
...
//            'gaji_pokok'     => 'right',
    ...
    public function add_new_deduction($class_mdl, $fetch_method, $name, $text, $annotation){
...
//                    ),
                    ...
                    'r' => array(
                        ...
                        'text' => '<span class="fa fa-cog fa-border"></span>',
                    ),
                    'd' => array(
    ...
    public function update_deduction($id, $class_mdl, $fetch_method, $name, $text, $annotation){
        $this->db->set('class_mdl', $class_mdl);
        $this->db->set('fetch_method', $fetch_method);
        $this->db->set('name', $name);
        $this->db->set('text', $text);
