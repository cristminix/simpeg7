...
class Adm_Shodaqoh_Mdl extends Apppayroll_Frontmdl {
...
//            'gaji_pokok'     => 'right',
    ...
    public function delete_shodaqoh($id) {
        $this->db->where('id', $id);
        $this->db->set('ddc_shd', NULL);
    ...
    public function fetch_all_shodaqoh() {
...
//        $db = $this->load->database('default', true);
    ...
    public function get_rs_action() {
        ...
        $dl_title .= lang('Download Shodaqoh');
        $dl_title .= ' ';
        ...
        $action   = array(
            ...
            'view_data' => array(
                ...
                'action_top'  => array(
                    'dl' => array(
                        'url'  => sprintf($r_url, md5('dl-shodaqoh-tpl' . date('ymd'))),
                        'text' => $dl_title,
                    ),
                    'im' => array(
...
//                    ),
    ...
    public function update_batch_shodaqoh($data, $key) {
        $this->db->update_batch($this->tbl, $data, $key);
        return $this->db->affected_rows();
    }

    public function update_shodaqoh($id, $ddc_shd) {
