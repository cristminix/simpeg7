...
class Adm_Wc_Mdl extends Apppayroll_Frontmdl {

    public $payslip_mdl_inst              = 'payslip_mdl';
    public $tbl                           = 'apr_empl_wc';
    ...
    public $rs_use_form_filter            = 'apr_empl_wc';
...
//                        'a_class' => 'btn btn-sm btn-primary',
    ...
    public function update_member($edit_id, $wc_id, $member_pos, $member_since, $member_term) {
