...
<div class="col-md-5" style="padding-top: 5px;padding-bottom: 15px;">
	<div class="panel panel-info">
		<div class="panel-heading">
			<div class="row">
				<div class="col-lg-10">
					<b><?=$isi->sk_pns_nomor;?></b>
				</div>
				<div class="col-lg-2">
					<div class="btn btn-primary btn-xs  pull-right" onclick="viewForm('<?=$komponen;?>','edit','<?=$isi->id;?>');return false;"><i class="fa fa-edit fa-fw"></i> Edit</div>
				</div>
			</div>
		</div>
		<div class="panel-body">
			<div class="row">
							...
							<div class="col-md-8" style="padding:5px;">
								...
								<div><input type=text class="form-control" value="<?=date("d-m-Y", strtotime($isi->sk_pns_tanggal));?>" disabled></div>
								<div><b>TMT PNS:</b></div>
								<div><input type=text class="form-control" value="<?=date("d-m-Y", strtotime($isi->tmt_pns));?>" disabled></div>
							</div>
			</div>
		</div>
	</div>
