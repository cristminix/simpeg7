...
/**
 * This library to fix compatibility with php7 
 * replace mcrypt extension to openssl
 */
class MY_Encrypt extends CI_Encrypt
{
	...
	function mcrypt_encode($data, $key)
	{
		...
		return $this->_add_cipher_noise( $this->_encrypt_stuff($key, $data, $iv),$key,$data );
	}
	...
	function mcrypt_decode($data, $key)
	{
		...
		return rtrim($this->_decrypt_stuff($key,$data,$iv));
	...
	function _decrypt_stuff($key, $str, $iv) {
	...
	function _encrypt_stuff($key, $str, $iv) {
