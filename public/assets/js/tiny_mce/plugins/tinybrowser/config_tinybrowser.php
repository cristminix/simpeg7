...
$tinybrowser['obfuscate'] = 'm3r4nd0m';
...
//$tinybrowser['docroot'] = rtrim($_SERVER['DOCUMENT_ROOT'].'/framework/');
...
$tinybrowser['path']['image'] =  "assets/media/file/"; //'/images/';//'/useruploads/images/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = '/media/'; //'/useruploads/media/'; // Media files location
$tinybrowser['path']['file']  = '/files/'; //'/useruploads/files/'; // Other files location
$uri = explode("/",$_SERVER['REQUEST_URI']);
//print_r($uri);
//$URL_LINK = 'http://'.$_SERVER['SERVER_NAME']."/".$uri[1]."/";
$URL_LINK = 'http://'.$_SERVER['SERVER_NAME']."/".$uri[0]."/";
...
$tinybrowser['link']['image'] = $URL_LINK .$tinybrowser['path']['image']; // Image links
